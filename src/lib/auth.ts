// Minimal single-password auth. A correct password mints an HMAC-signed cookie;
// middleware verifies it on every request. No user table — just one shared
// password for the advisor. Uses Web Crypto so it runs on both the Node and
